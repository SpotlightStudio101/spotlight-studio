...
const fr: typeof en = {
  meta: {
    homeTitle: "Quentin Mouledous — Vidéaste à Paris",
    homeDescription:
    ...
    devisTitle: "Demander un devis — Quentin Mouledous",
    ...
    bookCallTitle: "Réserver un appel — Quentin Mouledous",
  ...
  nav: {
    ...
    about: "À propos",
    contact: "Contact",
    tagline: "Vidéaste — publicité, documentaire, narratif",
    instagram: "Instagram ↗",
    youtube: "YouTube ↗",
